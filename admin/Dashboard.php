...
<div class="container my-5">
    <div class="h2 text-start text-light">Hello <?php echo $row[1] ?>,<br> Welcome To ShopMe Admin Pannel</div>
    <div class="row my-4">
        <div class="col-md-6">
            <!-- 1 -->
            <div class="card">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body bg-success text-light rounded-4">
                                    <p class="card-text">Total Availabel Stock | <?php echo $row ?> Products</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row my-4">
        ...
        <div class="col-md-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="card-text">Categorie Information</p>
                    <?php
